...
const ContentPrint = ({ date, image, from, to, items, qno, setQno,q,sq }) => {
        ...
        <main className="p-6">
            ...
            <div ref={componentRef}>
                <div className="my-8 sm:m-12 p-2 sm:p-6 border border-gray-500 rounded-xl text-gray-500 ">
                    <PrintTop image={image} qno={qno} date={date} title={"Quotation"} no="Quotation No " Date="Quotation Date " q={q} sq={sq} />
